...
const tableName = 'muqu_rooms';

const ENDPOINT = "https://40ym20hp8g.execute-api.us-east-2.amazonaws.com/dev";
...
exports.handler = async(event) => {
    try {
        ...
        const connectionIds = await dynamo.send(new ScanCommand({ TableName: 'muqu_current_users' }));
